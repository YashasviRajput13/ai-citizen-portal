    ...
    <div className="w-72 bg-slate-900 border-r border-slate-800 flex flex-col h-screen fixed left-0 top-0 z-50">
      ...
      <div className="p-6">
        <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-700/50">
          ...
          <button className="w-full text-[10px] font-bold text-slate-400 hover:text-white transition-colors bg-slate-700/50 py-2 rounded-lg border border-slate-600/50">
            MANAGE IDENTITY
          </button>
        </div>
      </div>
